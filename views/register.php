...
<div class="container mt-5 d-flex justify-content-center">
    <div class="col-md-6 p-4 rounded shadow-sm custom-form-background">
        ...
        <?php if (isset($_SESSION['errors']) && !empty($_SESSION['errors'])): ?>
            ...
            <?php unset($_SESSION['errors']); // Effacer les erreurs après affichage ?>
        <?php endif; ?>


        <form id="registrationForm" action="../controllers/register_controller.php" method="POST" class="needs-validation" novalidate>
    <div class="row mb-3">
        <div class="col">
    ...
    <div class="input-group">
        <input type="password" class="form-control" id="password" name="password" required pattern="(?=.*\d)(?=.*[A-Z])(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}">
